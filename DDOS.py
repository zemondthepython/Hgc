...
def usage():
	...
	print 'Usage: python iStorm.py (url)'
	print 'Example: python iStorm.py http://luthi.co.il/'
	print "\a"
print \
"""                                                       
                                  ###################
...
def httpcall(url):
	...
	try:
			...
			set_flag(1)
 			print '                                                                    '
 			print '#~~~~~~~> Nigger racers <~~~~~~~~#~~~>#WeareRiotsecniggerslmaooo<~~#'
 			print '#~~~~~~> your data  belong2us <~~~~~#~~~~~~~~~>trashskidsa<~~~~~~~~#'
 			print '#~~~~~~> Your server is p00p <~~~~~~~#~~~~>ur web d1 today boi<~~~~#'
 			print '#~~~> rip ur website <~~~#~~~>iStorm DDoS Tool is used in this <~~~#'
 			print '                                                                    '
			code=500
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print("Starting chaos and a storm inside some webserver lmao")
		print("Created by Riotsec n00bs")
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
